...
case class HttpErrorModel(code: String, message: String) extends HttpError

object HttpErrorModel {
  implicit val format: Format[HttpErrorModel] = Json.format[HttpErrorModel]
}
...
case object UnknownHttpError extends HttpError {
