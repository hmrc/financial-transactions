...
object ChargeTypes extends LoggerUtil {
  ...
  private val supportedChargeTypes: Map[(String, String), String] = Map(
    ...
    ("4623", vatInterestRepaymentsSubTrans) -> "VAT Return 1st LPP RPI",
    ...
    ("4638", vatLPISubTrans) -> "VAT Manual LPI",
    ("4639", vatInterestRepaymentsSubTrans) -> "VAT Manual RPI",
    ("4652", vatLPISubTrans) -> "VAT Central Assessment LPI",
    ("4653", vatInterestRepaymentsSubTrans) -> "VAT Central Assessment RPI",
    ("4654", vatLPISubTrans) -> "VAT CA 1st LPP LPI",
    ("4655", vatInterestRepaymentsSubTrans) -> "VAT CA 1st LPP RPI",
    ("4656", vatLPISubTrans) -> "VAT CA 2nd LPP LPI",
    ("4657", vatInterestRepaymentsSubTrans) -> "VAT CA 2nd LPP RPI",
    ...
    ("4661", vatInterestRepaymentsSubTrans) -> "VAT OA 1st LPP RPI",
    ("4663", vatInterestRepaymentsSubTrans) -> "VAT OA 2nd LPP RPI",
    ...
    ("4667", vatInterestRepaymentsSubTrans) -> "VAT Error Correct 1st LPP RPI",
    ("4668", vatLPISubTrans) -> "VAT Error Correct 2nd LPP LPI",
    ("4669", vatInterestRepaymentsSubTrans) -> "VAT Error Correct 2nd LPP RPI",
    ("4670", vatLPISubTrans) -> "VAT Additional Assessment LPI",
    ("4671", vatInterestRepaymentsSubTrans) -> "VAT Additional Assessment RPI",
    ("4672", vatLPISubTrans) -> "VAT AA 1st LPP LPI",
    ("4673", vatInterestRepaymentsSubTrans) -> "VAT AA 1st LPP RPI",
    ("4674", vatLPISubTrans) -> "VAT AA 2nd LPP LPI",
    ("4675", vatInterestRepaymentsSubTrans) -> "VAT AA 2nd LPP RPI",
    ("4676", vatLPISubTrans) -> "VAT Protective Assessment LPI",
    ("4677", vatInterestRepaymentsSubTrans) -> "VAT Protective Assessment RPI",
    ("4678", vatLPISubTrans) -> "VAT PA 1st LPP LPI",
    ("4679", vatInterestRepaymentsSubTrans) -> "VAT PA 1st LPP RPI",
    ("4680", vatLPISubTrans) -> "VAT PA 2nd LPP LPI",
    ("4681", vatInterestRepaymentsSubTrans) -> "VAT PA 2nd LPP RPI",
    ...
    ("4697", vatLPISubTrans) -> "VAT Carter Penalty LPI",
    ("4698", vatInterestRepaymentsSubTrans) -> "VAT Carter Penalty RPI",
    ...
    ("4752", vatInterestRepaymentsSubTrans) -> "VAT LSP Repayment Interest",
    ...
    ("4767", vatLPISubTrans) -> "VAT FTN Mat Chg Post 2010 LPI",
    ("4770", penaltyDebitSubTrans) -> "VAT Inaccuracies in EC Sales",
    ("4771", vatLPISubTrans) -> "VAT Inaccur in EC Sales LPI",
    ...
    ("4777", vatLPISubTrans) -> "VAT FTN Each Partner LPI",
    ...
    ("4784", vatLPISubTrans) -> "VAT Inaccuracy Return Replaced LPI",
    ...
    ("4789", vatInterestRepaymentsSubTrans) -> "VAT Manual LPP RPI",
    ("4790", penaltyDebitSubTrans) -> "VAT FTN RCSL",
    ("4791", vatLPISubTrans) -> "VAT FTN RCSL LPI",
    ("4793", penaltyDebitSubTrans) -> "VAT Failure to submit RCSL",
    ("4794", vatLPISubTrans) -> "VAT Failure to Submit RCSL LPI",
    ("4796", penaltyDebitSubTrans) -> "VAT MP pre 2009",
    ("4797", vatInterestRepaymentsSubTrans) -> "VAT RPI Recovery",
