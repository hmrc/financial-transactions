...
class FinancialDataQueryParametersSpec extends SpecBase {
  ...
  "The FinancialDataQueryParameters object" should {
    ...
    "have the correct key value for 'removePOA'" in {
      removePOAKey shouldBe "removePOA"
    }
  ...
  "The FinancialDataQueryParameters.toSeqQueryParams method" should {
    ...
    "output the expected sequence of key-value pairs" which {
      ...
      "for no Query Parameters, has the correct required fields by default" in {
        val queryParams = FinancialDataQueryParameters()
        queryParams.toSeqQueryParams shouldBe financialDataQueryParamsDefault
      }
      ...
      "for fromDate Query Param, has a 'dateFrom' param with correct value" in {
        ...
        queryParams.toSeqQueryParams shouldBe Seq(dateFromKey -> "2018-04-06") ++ financialDataQueryParamsDefault
      }
      ...
      "for toDate Query Param, has a 'dateTo' param with correct value" in {
        ...
        queryParams.toSeqQueryParams shouldBe Seq(dateToKey -> "2019-04-05") ++ financialDataQueryParamsDefault
      }
      ...
      "for onlyOpenItems Query Param, has a 'onlyOpenItems' param with correct value" in {
        ...
        queryParams.toSeqQueryParams shouldBe financialDataQueryParamsOpenItems
      }
      ...
      "for all Query Params, outputs them all as expected" in {
        financialDataQueryParamsFullObj.toSeqQueryParams shouldBe financialDataQueryParamsFull
      }
    }
  }
}
